...
/* [작성법]
   CREATE TABLE [IF NOT EXISTS] 테이블명 (
       컬럼1 자료형 [제약조건 | AUTO_INCREMENT] [DEFAULT 기본값] [COMMENT],
       컬럼2 자료형 [제약조건] [DEFAULT 기본값] [COMMENT],
       컬럼3 자료형 [제약조건] [DEFAULT 기본값] [COMMENT],
       ...
   );
 */
...
(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
(3, 'user03', 'pass03', '이순신', '남', '010-8888-8888', 'lee222@gmail.com');
...
# Duplicate entry '3-100-2026-06-12 11:31:31' for key 'order_composite_pk.PRIMARY'
